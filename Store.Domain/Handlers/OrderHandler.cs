...
public class OrderHandler : Notifiable, IHandler<CreateOrderCommand>
{
    ...
    public OrderHandler(ICustomerRepository customerRepository, IDeliveryFeeRepository deliveryRepository, IDiscountRepository discountRepository, IProductRepository productRepository, IOrderRepository orderRepository)
    {
